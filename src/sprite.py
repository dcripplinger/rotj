...
class Sprite(pygame.sprite.Sprite):
    def __init__(self, tmx_data, game, character, velocity=None, position=None, speed=10, direction='s'):
    ...
    def handle_cell(self):
        pass # we use this in the clas Hero (which inherits from here) to teleport to different maps
